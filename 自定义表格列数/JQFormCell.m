...
//    UIView *view= [[NSBundle mainBundle] loadNibNamed:@"JQButtonView" owner:self options:nil][0];
...
//    self.contentView.backgroundColor = self.jq_FormBackgroundColor?self.jq_FormBackgroundColor:[UIColor lightGrayColor];
